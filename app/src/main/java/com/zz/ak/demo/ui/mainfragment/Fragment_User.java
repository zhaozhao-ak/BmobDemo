...
public class Fragment_User extends BaseFragment implements OnQuickSideBarTouchListener,TimeInterface {
    ...
    Fragment_User.CityListWithHeadersAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new Fragment_User.CityListWithHeadersAdapter();
